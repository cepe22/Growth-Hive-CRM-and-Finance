export type FinancialReport = {
  ...
  note?: string; balanceSheetPeriod?: string;
...
export const financial2026: FinancialReport = {
  year:"2026",status:"Year to date",source:"Reporting GHI 2026.xlsx + Rekening Koran Juni-Juli 2026",sourceUrl:"https://docs.google.com/spreadsheets/d/1-_zuWzIJJjakZnbyujjEwvff_Qq6Rwsw/edit",period:"Januari - Juli 2026",
  note:"Juni-Juli memakai basis mutasi rekening: kredit sebagai pendapatan kas, debit dipetakan ke biaya, pembayaran pajak dipisahkan, dan penyusutan mengikuti jadwal aset. Balance sheet masih memakai posisi formal terakhir Mei 2026.",balanceSheetPeriod:"Mei 2026 (data formal terakhir)",
  revenue:334042395,costOfRevenue:15800000,operatingExpenses:329121231,totalExpenses:344921231,operatingProfit:-10878836,tax:622482,netIncome:-11501318,netMargin:-.0344307135,
  months:[{month:"Jan",revenue:62363173,expenses:67080571,netIncome:-4717398},{month:"Feb",revenue:61979000,expenses:60207991,netIncome:1771009},{month:"Mar",revenue:50575914,expenses:71342291,netIncome:-20766377},{month:"Apr",revenue:40397000,expenses:43750106,netIncome:-3353106},{month:"Mei",revenue:31688000,expenses:36994606,netIncome:-5306606},{month:"Jun",revenue:43792500,expenses:32301583,netIncome:11179676},{month:"Jul",revenue:43246808,expenses:33244083,netIncome:9691484}],
  expenseCategories:[{label:"Biaya Gaji",amount:253231000},{label:"Professional Fee",amount:38923078},{label:"Biaya Produksi",amount:14700000},{label:"THR",amount:11000000},{label:"Iklan & Promosi",amount:9700000},{label:"Tunjangan PPh 21",amount:8345242},{label:"Biaya Sewa",amount:4000000},{label:"Transportasi & Perjalanan Dinas",amount:2187200},{label:"Biaya Talent",amount:1100000},{label:"Penyusutan",amount:802081},{label:"Meeting",amount:652630},{label:"Administrasi Bank",amount:280000}],
